    ...
    <div className={styles.wrapper}>
      <div className={styles.content}>
        <div className={styles.body}>
          <div>
            <Text size="xl">FREE Life Insurance Quote For You</Text>
          </div>
          <div>
            <Text size="base">
              Sofie will help you find the right life insurance, for free. It’s quick and easy, and means your family is
