...
const radios: RadioItemType[] = [
  { keyboard: "A", label: "Employed", value: "Employed" },
  { keyboard: "B", label: "Self-Employed", value: "Self-Employed" },
];

const EmploymentStatus = () => {
  const selected = useSelector((state: { main: StateType }) => state.main).formData?.employment_status;
  ...
  return (
    <ContentWrapper
      ...
      buttonLabel="OK"
      ButtonIcon={Check}
      nextPage={formData === "Employed" ? "6" : "11"}
