...
const CurrentlyHaveInsurance = () => {
  const main = useSelector((state: { main: StateType }) => state.main);
  const selected = main.formData?.currently_have_insurance;
  ...
  const submitFunction = () => {
    dispatch(
      setFormDataInfo({
        formData: {
          currently_have_insurance: formData,
        },
      })
    );
  };
  ...
  return (
    <ContentWrapper
      title={`Does the ${main.formData.vehicle_model}, ${main.formData.vehicle_brand} currently have insurance?*`}
      buttonLabel="OK"
      ButtonIcon={Check}
      nextPage="27"
...
export default CurrentlyHaveInsurance;
