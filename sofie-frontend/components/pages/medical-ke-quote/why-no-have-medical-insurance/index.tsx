...
const WhyNoHaveMedicalInsurance = () => {
  const selected = useSelector((state: { main: StateType }) => state.main).formData?.why_no_have_medical_insurance;
  ...
  const submitFunction = () => {
    dispatch(
      setFormDataInfo({
        formData: {
          why_no_have_medical_insurance: formData,
        },
      })
    );
  };
...
export default WhyNoHaveMedicalInsurance;
